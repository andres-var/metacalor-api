...
export class CaloriesConsumedController{
    constructor(private readonly caloriesConsumedService: CaloriesConsumedService){}

    @Post()
    create(@Body() createCaloriesConsumedDto: CreateCaloriesConsumedDto, @CurrentUser() user: User){
