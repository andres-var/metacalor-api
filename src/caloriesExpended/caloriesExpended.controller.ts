...
export class CaloriesExpendedController{
    constructor(private readonly caloriesExpendedService: CaloriesExpendedService ){}

    @Post()
    create(@Body() createCaloriesExpendedDto: CreateCaloriesExpendedDto, @CurrentUser() user: User){
    ...
    async findAll(
        ...
        return this.caloriesExpendedService.findAll(page,limit);
    }
}